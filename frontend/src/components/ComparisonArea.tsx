...
import type { Sentence, PhraseSentence, LanguageData, PhraseData } from '../types';
...
function LanguageBlock({
    ...
    useEffect(() => {
        ...
        tokenElements.forEach(tokenEl => {
            ...
            drawArrow(svg, el, headToken, container, langCode, tokenById, onTooltipShow, onTooltipHide);
        });

    }, [showDependencyGraph, tokens, zoom, langCode, tokenById, onTooltipShow, onTooltipHide]);
...
export function ComparisonArea({
    ...
    return (
        <div className="comparison-area">
            <ZoomControls zoom={zoom} onZoomChange={onZoomChange} onZoomReset={onZoomReset} />
