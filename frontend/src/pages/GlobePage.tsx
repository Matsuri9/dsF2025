...
import { useSimilarityData, useHeadDirectionRates } from '../hooks/useLanguageData';
...
export function GlobePage() {
    ...
    const selectedNode = selectedNodeCode ? LANGUAGE_LOCATIONS.find(l => l.code === selectedNodeCode) : null;
            ...
            {selectedNode && (
                <div className="selected-node-panel">
                    <div className="selected-node-header">
                        ...
                        <button className="clear-btn" onClick={handleClearSelection}>×</button>
                    </div>
                    ...
                    <div className="legend-content">
                        ...
                        <div className="legend-filters">
                            <label className="filter-item">
                                ...
                                />
                                <span className="color-sample" style={{ background: '#3b82f6' }}></span>
                            ...
                            <label className="filter-item">
                                ...
                                />
                                <span className="color-sample" style={{ background: '#22c55e' }}></span>
                                <span>近い (&lt;0.1)</span>
                            </label>
                            <label className="filter-item">
                                <input
                                ...
                                />
                                <span className="color-sample" style={{ background: '#84cc16' }}></span>
                                <span>やや近い (&lt;0.3)</span>
                            </label>
                            <label className="filter-item">
                                <input
                                ...
                                />
                                <span className="color-sample" style={{ background: '#facc15' }}></span>
                                <span>やや遠い (&lt;0.5)</span>
                            </label>
                            <label className="filter-item">
                                <input
                                ...
                                />
                                <span className="color-sample" style={{ background: '#f97316' }}></span>
                                <span>遠い (&lt;0.7)</span>
                            </label>
                            <label className="filter-item">
                                <input
                                ...
                                />
                                <span className="color-sample" style={{ background: '#ef4444' }}></span>
                                <span>非常に遠い (≥0.7)</span>
                            </label>
                        </div>
